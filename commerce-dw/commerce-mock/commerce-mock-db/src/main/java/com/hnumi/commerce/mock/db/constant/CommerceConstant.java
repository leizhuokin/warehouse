package com.hnumi.commerce.mock.db.constant;
...
public class CommerceConstant {
    ...
    public static final String ORDER_STATUS_REFUNDING = "1005";
    ...
    public static final String PAYMENT_STATUS_TODO = "1601";
    public static final String PAYMENT_STATUS_DONE = "1602";
    public static final String PAYMENT_STATUS_CANCEL = "1603";
