package com.hnumi.commerce.mock.log.config;
...
public class AppConfig {
    ...
    public void setSkuWeightMale(String skuWeightMaleStr) {
        skuWeightMale = ParamUtil.checkRate(skuWeightMaleStr, new int[0]);
    }

    @Value("${mock.sku-weight.female}")
    public void setSkuWeightFemale(String skuWeightFemaleStr) {
        skuWeightFemale = ParamUtil.checkRate(skuWeightFemaleStr, new int[0]);
    }
    ...
    public void setSourceType(String sourceTypeRate) {
        Integer[] sourceTypeRateArray = ParamUtil.checkRate(sourceTypeRate, new int[]{4});
